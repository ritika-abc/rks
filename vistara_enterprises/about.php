...
<body>
                ...
                <div class="row ">
                    <div class="col-12 col-sm-12  text-center m-auto col-md-8 col-lg-7  ">
                        <div class="bg_content " data-aos="fade-up" data-aos-anchor-placement="top-center">
                            <div class="text_pera">
                                <h4 class="display-4 text-warning">About Us</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item "><a href="index.php" class="text-white">Home</a>
                                        </li>
    ...
    <div class="container margin" data-aos="fade-up" data-aos-anchor-placement="top-center">
        <h4 class="display-6 text-center   heading">About Us</h4>
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-9 mt-5">
                    <p> <b> SPICE UP YOUR LIFE WITH OUR PREMIUM SELECTION OF AROMATIC SPICES! </b> </p>
                    <p>At <strong class="text-success border-bottom fs-5"> "Vistara Enterprise" </strong>  Exim, we bring you a world of flavor with our exquisite range of spices
                        sourced from the finest regions across the globe. Elevate your culinary creations and tantalize
                        your taste buds with our handpicked selection, meticulously processed and packaged to preserve
                        freshness and aroma.</p>
                        <p>Indulge in the finest flavors!Our spices and masalas are meticulously milled and blended to
                            perfection, ensuring maximum potency and flavor. Eat the best—because you deserve nothing less!
                        </p>
                    <!-- <img src="assets/image/icon/tree.webp" height="auto" width="100%" alt=""> -->

                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-3">
                    <img src="assets/image/icon/spices.png" height="auto" width="100%" alt="">
                </div>
            </div>

            <div class="border-bottom my-2 d-block d-lg-none"></div>
            <div class="row my-5">
                <div class="col-12 col-md-12 col-lg-3">
                    <img src="assets/image/icon/tree.webp" height="auto" width="100%" alt="">
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-9">
            <h4 class=" my-2">Grated coconut</h4>

                    <p>Nutritional value: Grated coconut is packed with healthy fats, fiber, vitamins, and minerals,
                        providing essential nutrients for your body.
                        Flavor enhancer: It adds a delightful tropical flavor and aroma to a wide range of dishes,
                        including curries, desserts, and salads.
                        Textural element: The chewy and moist texture of grated coconut enhances the overall taste and
                        mouthfeel of various recipes.</p>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-3 mb-3">
                    ...
                    <ul class="navbar-nav mt-3 text-capitalize">
                        <li class="nav-item"><a href="index.php" class="nav-link p-0"> <i
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-3 mb-3">
                    ...
                    <ul class="navbar-nav mt-3">
                        <li class="nav-item "><a href="" class="nav-link p-0 fw-bold"><i
                            class="fa-solid fa-building-wheat mx-1 "></i>7/3  Ayyanar Kovil Road , Rajapalayam  ,
                            Tamil Nadu  <br> 626117
                    </a></li>
                        <li class="nav-item mt-2"><a href="milto:kshnsp5@gmail.com" class="nav-link p-0"><i
                                    class="fa-regular fa-envelope mx-1"></i> kshnsp5@gmail.com</a></li>
