...
if (isset($_POST['submit'])) {
    ...
    $to = $user_email;
    $subject = "Enquiry From  " . "<q>Vistara Enterprise</q>";
                            ...
                            <div class="text_pera">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item "><a href="index.php" class="text-white text-decoration-none">Home</a>
                                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-4 my-3">
                            <div class="contact_box text-center">
                                ...
                                <a href="milto:kshnsp5@gmail.com" class="text-decoration-none text-muted  mt-2 d-block fw-bold  fs-6">kshnsp5@gmail.com</a>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-4 my-3">
                            <div class="contact_box text-center ">
                                ...
                                <a href="" class="text-decoration-none text-muted  mt-2 d-block fw-bold  fs-5">7/3 Ayyanar Kovil Road , Rajapalayam ,
                                    Tamil Nadu 626117</a>
                            </div>
                        </div>
                    </div>
