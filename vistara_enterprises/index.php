                ...
                <div class="row ">
                    <div class="col-12 col-sm-12 col-md-8 col-lg-7  ">
                        ...
                        data-aos-anchor-placement="top-center">
                            <div class="text_pera">
                                <h4 class="display-4 text-warning fw-bold" >"Vistara Enterprise"</h4>
                ...
                <div id="slide_1" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/image/slider-coconut2.jfif" class="d-block w-100" alt="...">
                        </div>
                        <!-- <div class="carousel-item">
                            <img src="assets/image/specii-min.png" class="d-block w-100" alt="...">
                        </div> -->
                        <div class="carousel-item">
                            <img src="assets/image/slider_coconut.jfif" class="d-block w-100" alt="...">
                        </div>
                    </div>
        ...
        data-aos-anchor-placement="top-center">
            <div class="col-12 col-md-12 col-lg-6 mb-3">
                <div id="slide_2" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="assets/image/slider-spices1.jfif" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/image/slider-spices2.jfif" class="d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-12 col-lg-6 mb-4">
                <div class="about_section  p-3" id="p_none2">
                    <h4 class="fs-4 heading"><q><i>Spices</i> </q></h4>
                    <p class="mt-3">Indulge in the finest flavors!Our spices and masalas are meticulously milled and blended to perfection, ensuring maximum potency and flavor. Eat the best—because you deserve nothing less!</p>
                    <div class="about_btn">
                        <a href="about.php" class="mt-3 d-block"><button>read more </button></a>
                    </div>
                </div>
                        ...
                        <div class="col-12 col-md-9 m-auto">
                            <div class="why_choos_us ">
                                <div class="text-center">
                                    <h4 class="display-6 heading">Services</h4>
                ...
                <div class="row">
                    <div class="col-12 col-md-4 mt-3">
                        <div class="cards shadow-lg p-4">
                            <div class="  m-auto">
                                <img src="assets/image/icon/manufacture.png" alt="">
                            </div>
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        <div class="cards shadow-lg p-4">
                            <div class="  m-auto">
                                <img src="assets/image/icon/icons8-export-100.png" alt="">
                            </div>
                            <h4>We Export</h4>
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        <div class="cards shadow-lg p-4 ">
                            <div class="  m-auto">
                                <img src="assets/image/icon/icons8-products-100.png" alt="">
                            </div>
                            <h4>We Supply</h4>
